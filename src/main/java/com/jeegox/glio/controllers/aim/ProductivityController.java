...
public class ProductivityController extends BaseController {
    ...
    @Autowired
    public ProductivityController(UserService userService, ProjectService projectService) {
    ...
    public List<GraphProductivityDTO> findDataGraphProductivity(HttpServletRequest request,
            @RequestParam String initDate, @RequestParam String endDate, @RequestParam Integer idProject, @RequestParam Integer idAim){
