...
public class UserDAOTest {
    ...
    @Test
    public void countByCompany_companyExists_two(){
        Company company = new Company(1, "Mcdonals", "hamburguesas", Status.ACTIVE, 3);
        assertThat(userDAO.count(company)).isEqualTo(2);
    }
    ...
    @Test
    public void findByCompanyAndName_nameWithTwoResults_listWithTwoElements(){
        Company company = new Company(1, "Mcdonals", "hamburguesas", Status.ACTIVE, 3);
        assertThat(userDAO.findByCompany(company, "admin")).isEqualTo(expectedUserListByCompany());
    }

    @Test
    public void findByCompanyAndName_nameWithOnlyOneResult_listWithOnlyOneElement(){
        Company company = new Company(1, "Mcdonals", "hamburguesas", Status.ACTIVE, 3);
        assertThat(userDAO.findByCompany(company, "admin2")).containsExactly(expectedUser2);
    }

    @Test
    public void findByCompanyAndName_nameWithoutResults_emptyList(){
        Company company = new Company(1, "Mcdonals", "hamburguesas", Status.ACTIVE, 3);
        assertThat(userDAO.findByCompany(company, "admin23")).isEmpty();
    }
